...
A decentralized platform for tokenizing traditional crafts and supporting master artisans, built with Next.js and the Stellar blockchain. This platform enables artisans to preserve their cultural heritage while receiving direct support from patrons worldwide.

## 🎯 Features

### **Core Functionality**
- ✅ **Craft Gallery**: Browse authentic traditional crafts and workshops
- ✅ **Artisan Support**: Direct token-based support for master craftspeople
- ✅ **Heritage Verification**: Certified traditional craft authentication
- ✅ **Tokenization**: Transform artisanal works into supported tokens
- ✅ **Craft Documentation**: Preserve traditional techniques and heritage
- ✅ **Secure Transfers**: Safe and transparent support transactions

### **Architecture Highlights**
- **Modern Stack**: Next.js 14 + TypeScript + Tailwind CSS + shadcn/ui
- **State Management**: Efficient state management with React hooks
- **Type Safety**: Strong TypeScript typing for craft and token data
- **Traditional UI**: Craft-focused design with warm, earthy color scheme
- **Responsive Design**: Mobile-first approach for artisan accessibility
